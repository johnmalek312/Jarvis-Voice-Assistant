...
@register_tool()
def execute_code(code: str = Field(description="The python code to execute."), timeout: float = Field(7, description="The maximum time to allow for code execution in seconds")) -> str:
